...
#EDIT THE FOLLOWING:
$toAddress = "trananhhuy3003@gmail.com";  //place your/your client's email address here
$toName = "Huy Anh Tran"; //place your client's name here
$website = "Huy Anh Tran Web120 Portal";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Your Messages Have Been Received!</h2>
